...
export default function Dashboard({ userProfile, onLogout, onGoToProfile }: DashboardProps) {
  ...
  const handleSymptomToggle = (symptom: keyof typeof formData.symptoms) => {
    setFormData({
      ...formData,
      symptoms: {
        ...formData.symptoms,
  ...
  const [history, setHistory] = useState([
    { id: 1, date: "2024-04-15", likelihood: 78 },
    { id: 2, date: "2024-03-20", likelihood: 15 },
    { id: 3, date: "2023-11-12", likelihood: 45 },
  ]);
    ...
    const profiles = {
      ...
      HIGH: {
        ...
        recommendations: [
          ...
          { icon: AlertCircle, text: "Encourage immediate medical follow-up for diagnosis.", urgent: true },
              ...
              <div className="flex-1 space-y-8">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    />
                    <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-bold text-slate-900 uppercase tracking-widest px-1">Flow Intensity</label>
                      <select 
                        value={formData.heavyBleeding}
                        onChange={(e) => setFormData({...formData, heavyBleeding: e.target.value})}
                        className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-medical-primary/10 focus:border-medical-primary transition-all appearance-none"
                      >
                        <option value="no">Normal/Moderate Flow</option>
                        <option value="yes">Abnormally Heavy (Menorrhagia)</option>
                      </select>
                      <p className="text-[10px] text-slate-400 px-1 italic font-medium">Heavy flow means soaking through a pad/tampon every 1-2 hours.</p>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  <div className="flex items-center gap-2 mb-6 text-slate-400">
                    ...
                    <h2 className="text-sm font-bold text-slate-900 uppercase tracking-[0.2em]">Secondary Markers</h2>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <Checkbox label="Chronic Pelvic Pain" checked={formData.symptoms.pelvicPain} onChange={() => handleSymptomToggle("pelvicPain")} />
                    <Checkbox label="Persistent Fatigue" checked={formData.symptoms.fatigue} onChange={() => handleSymptomToggle("fatigue")} />
                  </div>
                </section>
            ...
            <section className="pt-8">
              ...
              {history.length > 1 && (
                <motion.div 
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm mb-6 overflow-hidden"
                >
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] font-medium text-slate-400 uppercase tracking-wider">{item.date}</p>
                        </div>
                      </div>
